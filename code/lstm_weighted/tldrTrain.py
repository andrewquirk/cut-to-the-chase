...
tf.app.flags.DEFINE_float("max_gradient_norm", 500.0, "Clip gradients to this norm.")
tf.app.flags.DEFINE_float("dropProb", 0.15, "Fraction of units randomly dropped on non-recurrent connections.")
